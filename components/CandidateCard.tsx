      ...
      >
        ...
        <div className="flex-1 w-full">
          <div className="flex flex-wrap items-center gap-3 mb-2">
            ...
            <span className="px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-[10px] font-bold uppercase tracking-widest">
        ...
        <div className="space-y-3 overflow-y-auto max-h-[300px] pr-2 custom-scrollbar">
          {sortedRepos.map((repo, i) => (
            <motion.a
              ...
              className="block group p-4 bg-white/5 rounded-2xl hover:bg-white/10 transition-all border border-transparent hover:border-indigo-500/30"
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2 overflow-hidden">
                  <span className="font-bold text-indigo-300 truncate group-hover:text-indigo-200 transition-colors">{repo.name}</span>
